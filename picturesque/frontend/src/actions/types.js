...
export const CLEAR_USER_BOUNTIES = "CLEAR_USER_BOUNTIES";
...
export const CLEAR_USER_PORTFOLIOS = "CLEAR_USER_PORTFOLIOS";
...
export const GET_USERNAME_FAVORITES = "GET_UESRNAME_FAVORITES";
